...
class MW (QWidget):
    ...
    def print_qsize(self):
        ...
        print("label3's size      :",self.label3.size()     ,"/",self.label3     .sizePolicy().verticalPolicy(),"/",self.label3     .sizePolicy().horizontalPolicy())
        print("label4's size      :",self.label4.size()     ,"/",self.label4     .sizePolicy().verticalPolicy(),"/",self.label4     .sizePolicy().horizontalPolicy())
