        ...
        for image in images:
            try:
                with open(image):
                    ...
                    if image == "img/profile_image.png":
                        label.move(80, 20)
            except FileNotFoundError as error:
                print(f"Image not found.\nError: {error}")
                
    def setUpMainWindow(self):
        sub_title_font = QFont('Arial', 12)
        ...
        bio_label.setFont(sub_title_font)
        ...
        skills_label.setFont(sub_title_font)
        ...
        experience_label.setFont(sub_title_font)
